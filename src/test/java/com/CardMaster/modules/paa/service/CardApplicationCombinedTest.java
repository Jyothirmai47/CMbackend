...
import com.CardMaster.modules.paa.controller.CardApplicationController;
...
class CardApplicationCombinedTest {
    ...
    void testControllerCreate() {
        ...
        ResponseEntity<ApiResponse<CardApplicationDto>> response =
                controller.create(dto, "Bearer token");

        assertEquals(HttpStatus.CREATED, response.getStatusCode());
        assertEquals("Application created successfully", response.getBody().getMsg());
    }
    ...
    void testControllerGetById() {
        ...
        assertEquals("Application retrieved successfully", response.getBody().getMsg());
    }
    ...
    void testControllerGetAllApplications() {
        ...
        ResponseEntity<ApiResponse<List<CardApplicationDto>>> response =
    ...
    void testControllerGetByCustomer_NoApplications() {
        ...
        assertEquals("Customer doesn't have any applications", response.getBody().getMsg());
    }
