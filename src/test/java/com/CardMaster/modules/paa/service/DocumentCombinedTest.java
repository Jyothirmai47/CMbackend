...
import com.CardMaster.modules.paa.controller.DocumentController;
...
public class DocumentCombinedTest {
    ...
    void testControllerUploadDocument() {
        ...
        assertEquals("Document uploaded successfully", response.getBody().getMsg());
    }
    ...
    void testControllerDeleteDocument() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Document deleted successfully", response.getBody().getMsg());
    }
