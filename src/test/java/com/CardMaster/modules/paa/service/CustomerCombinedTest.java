...
import com.CardMaster.modules.paa.controller.CustomerController;
...
public class CustomerCombinedTest {
    ...
    void setUp() {
        ...
        dto.setContactInfo(new ContactInfo("Addr", "alice@example.com", "1234567890"));
    ...
    void testGetAllCustomers_Success() {
        ...
        c1.setContactInfo(new ContactInfo("Addr1", "alice@example.com", "1111111111"));
        ...
        c2.setContactInfo(new ContactInfo("Addr2", "bob@example.com", "2222222222"));
    ...
    void testControllerCreateCustomer() {
        ...
        assertEquals("Customer created successfully", response.getBody().getMsg());
    }
    ...
    void testControllerDeleteCustomer() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Customer deleted successfully", response.getBody().getMsg());
    }
    ...
    void testControllerGetAllCustomers() {
        ...
        ResponseEntity<ApiResponse<List<CustomerDto>>> response =
